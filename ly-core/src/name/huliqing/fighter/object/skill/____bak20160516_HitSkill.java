...
//        // 查找角度限制范围内的敌人。
////        actorService.findNearestActors(actor, data.getRadius(), hitAngle, store); // remove20160503
...
//            Magic magic = magicService.loadMagic(mId);
//            magic.setTarget(target);
//            magic.setTraceObject(target.getModel());
//            playService.addMagic(magic);
//        }
//    }
//    
