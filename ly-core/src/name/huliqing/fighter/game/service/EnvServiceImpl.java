...
public class EnvServiceImpl implements EnvService {
    ...
    public static void main(String[] args) {
        System.out.println(new EnvServiceImpl().getMachineName());
    }
    ...
    public String getMachineName() {
        try {
            ...
            Logger.getLogger(EnvServiceImpl.class.getName()).log(Level.INFO, "Could not get machine name!", e);
            return "Unknow";
        }
    }
    ...
    public InetAddress getLocalHostIPv4() {
        try {
            ...
            Logger.getLogger(EnvServiceImpl.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
    ...
    public InetAddress getBroadcastAddress() {
        ...
        if (Config.debug) {
            Logger.getLogger(EnvServiceImpl.class.getName()).log(Level.INFO, "broadcast address={0}", broadcast);
        }
        try {
