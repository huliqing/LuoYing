...
//                }
    ...
    private class PicPanel extends LinearLayout {
        ...
        public PicPanel(float width, float height) {
            ...
            final Texture texture = Common.getAssetManager().loadTexture(InterfaceConstants.UI_MISS);
            mat = new Material(Common.getAssetManager(), MaterialConstants.MAT_FACE_PANEL);
        ...
        public void setActor(Actor actor) {
            ...
            Texture tex;
            try {
                tex = Common.getAssetManager().loadTexture(icon);
            } catch (AssetNotFoundException e) {
                tex = Common.getAssetManager().loadTexture(InterfaceConstants.UI_MISS);
            }
