...
public class SubnetUtils {
     ...
     * @throws IllegalArgumentException if the parameter is invalid, i.e. does
     * not match n.n.n.n/m where n=1-3 decimal digits, m = 1-3 decimal digits in
     * range 1-32
     */
     ...
     * @throws IllegalArgumentException if the address or mask is invalid, i.e.
     * does not match n.n.n.n where n=1-3 decimal digits and the mask is not all
     * zeros
     */
    ...
    /**
     * Returns
     * <code>true</code> if the return value of
    ...
    /**
     * Set to
     * <code>true</code> if you want the return value of
    ...
    public final class SubnetInfo {
         ...
         * <code>address</code> is in the range of usable endpoint addresses for
         * this subnet. This excludes the network and broadcast adresses.
         *
