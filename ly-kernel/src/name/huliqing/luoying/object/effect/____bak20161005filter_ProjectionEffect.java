...
//    // 用于处理和渲染被投射物体
//    private final ProjectionFilter projectionFilter = new ProjectionFilter();
//
//    @Override
...
//        playService.getScene().addFilter(projectionFilter);
//        
...
//            if (receivers.get(i).getCullHint() != Spatial.CullHint.Always 
...
//        receivers.clear();
//        playService.getScene().removeFilter(projectionFilter);
//        super.cleanup();
//    }
//    
//    // -------------------------------------------------------------------------
//    // 渲染投射处理器
//    // -------------------------------------------------------------------------
//    private class ProjectionFilter extends Filter  {
//
//        @Override
//        protected void initFilter(AssetManager manager, RenderManager renderManager, ViewPort viewPort, int w, int h) {
//            rm = renderManager;
//            vp = viewPort;
//            
...
//            if (!isVisiableProj()) {
//                if (Config.debug) {
//                    Logger.getLogger(name.huliqing.core.object.effect.ProjectionEffect.class.getName()).log(Level.INFO
