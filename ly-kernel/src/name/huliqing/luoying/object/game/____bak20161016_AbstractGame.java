...
//                initScene = Loader.load(data.getSceneData());
//            } else {
...
//                initScene = Loader.load(IdConstants.SYS_SCENE);
//            }
//            setScene(initScene);
//        }
//        
...
//                initGuiScene = Loader.load(data.getGuiSceneData());
//            } else {
//                initGuiScene = Loader.load(IdConstants.SYS_SCENE_GUI);
//            }
...
//        
////        // 将场景节点添加到游戏
////        attachScene(scene.getRoot(), guiScene.getRoot(), app);
//        
//        // 通知侦听器
//        if (listeners != null) {
