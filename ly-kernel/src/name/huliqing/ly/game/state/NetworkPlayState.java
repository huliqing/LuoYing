...
import name.huliqing.ly.game.view.ActorSelectView;
import name.huliqing.ly.game.view.ClientsWin;
...
public abstract class NetworkPlayState extends PlayState implements LanGame {
    ...
    public final void showSelectPanel(List<String> selectableActors) {
        if (actorPanel == null) {
            actorPanel = new ActorSelectView(LY.getSettings().getWidth(), LY.getSettings().getHeight(), app.getGuiNode());
