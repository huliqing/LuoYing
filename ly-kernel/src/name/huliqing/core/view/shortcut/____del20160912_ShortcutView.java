...
// */
//package name.huliqing.core.view.shortcut;
//
...
//        });
//        
//        setBackground(InterfaceConstants.UI_SHORTCUT_BACKGROUND2, true);
//
//        // 注册侦听器
...
//
//    @Override
//    public void onSkinAdded(Actor actor, Skin data) {
//        if (data == this.data) {
//            setNeedUpdate();
//        }
//    }
//
//    @Override
//    public void onSkinRemoved(Actor actor, Skin data) {
//        if (data == this.data) {
//            setNeedUpdate();
//        }
//    }
