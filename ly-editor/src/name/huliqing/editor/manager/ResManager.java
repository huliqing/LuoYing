...
public class ResManager {
    ...
    private final Map<String, Map<String, String>> LOCALE_RES = new HashMap<String, Map<String, String>>();
     ...
     */
    public void loadResource(String classPathFile, String encoding, String locale) {
     ...
     */
    public void loadResource(InputStream is, String encoding, String locale) {
    ...
    public void setLocaleDefault(String localeDefault) {
        this.locale_default = localeDefault;
    }
   ...
   /**
     ...
     * @return 
     */
    private String get(String key, Object[] params, String locale) {
