...
public class ModuleFieldConverter extends SimpleFieldConverter<JfxSceneEdit, EntityData> {
    ...
    private final ComponentSearch<ComponentDefine> componentInput = 
            new ComponentSearch(ComponentManager.getComponents(ComponentConstants.MODULE));
    ...
    public ModuleFieldConverter() {
        ...
        listView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<ModuleData>() {
            ...
            public void changed(ObservableValue<? extends ModuleData> observable, ModuleData oldValue, ModuleData newValue) {
                ...
                currentDisplayConverter = ConverterManager.createDataConverter(jfxEdit, newValue, ModuleFieldConverter.this);
